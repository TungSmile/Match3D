...
export class Responsive2D extends Component {
    ...
    resize() {
        ...
        //     let eff2 = tween()
        //         .by(0.5, { scale: new Vec3(-0.05, -0.05, -0.05) }) // Thu nhỏ
        //         .by(0.5, { scale: new Vec3(0.05, 0.05, 0.05) }) // Phóng to
        //     if (DataManager.instance.eff1)
        //         DataManager.instance.eff1.stop();
        //     DataManager.instance.eff1 = tween(node).repeatForever(eff2).start();// Bắt đầu tween
        // }
